...
var $addNum = (0, _jquery.default)('#addNum');
var $minusNum = (0, _jquery.default)('#minusNum');
var $rideNum = (0, _jquery.default)('#rideNum');
var $besidesNum = (0, _jquery.default)('#besidesNum');
...
$rideNum.on("click", function () {
  var n = parseInt($output.text());
  n *= 2;
  $output.text(n);
  localStorage.setItem('n', n);
});
$besidesNum.on("click", function () {
  var n = parseInt($output.text());
  n /= 2;
  $output.text(n);
  localStorage.setItem('n', n);
...
var $showTag = (0, _jquery.default)('#showTag');
$tag.on('click', 'li', function (e) {
  var $li = (0, _jquery.default)(e.currentTarget);
  $li.addClass('selector').siblings().removeClass('selector');
  var index = $li.index();
  console.log(index);
  $showTag.children().eq(index).addClass('active').siblings().removeClass('active');
});
$tag.children().eq(0).trigger('click');
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"app3.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var $wear = (0, _jquery.default)('#wear');
$wear.mouseenter(function () {
  $wear.addClass('change');
});
$wear.mouseleave(function () {
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./global.css":"global.css","jquery":"node_modules/jquery/dist/jquery.js","./app1.css":"app1.css","./app1.js":"app1.js","./app2.css":"app2.css","./app2.js":"app2.js","./app3.css":"app3.css","./app3.js":"app3.js","./app4.css":"app4.css","./app4.js":"app4.js"}],"C:/Users/Administrator/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
